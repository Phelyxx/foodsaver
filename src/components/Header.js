        ...
        <Container>
            <Dropdown>
                ...
                <Dropdown.Menu>
                    ...
                    <Dropdown.Item href={"/profile/" + props.userId}>Your restaurant</Dropdown.Item>
                </Dropdown.Menu>
            </Dropdown>
        </Container>
    )
        ...
        <div className="Header" xxl={10}>
            <Container style={{ columnGap: "0px", width: "100%" }}>
                <Row  >
                    ...
                    <Col sm={2} md={2} lg={2} >
                        <Link onClick= {() => localStorage.removeItem("idUser")} to={"/signup"} style={{fontFamily: "Work Sans, sans-serif", fontStyle: 'normal',fontSize: '15px', color: '#42DC00'}}><FormattedMessage id = "CerrarSesion"/></Link>
                    </Col>
                    ...
                    <Col sm={2} md={2} lg={2} className="login_container">
                        ...
                        <Button onClick={signIn} className='mt-4' style={{ color: "white", background: '#42DC00', width: '150px', height: '40px' }} >
